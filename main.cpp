...
const string product_1 = "Product_1";
const string product_2 = "Product_2";
...
void SellProduct()
{
    ...
    OFile << d1.name << "\t\t\t" << d1.product << "\t\t\t" << d1.price << "\t\t\t" << d1.quantity << "L"
          << "\t\t\t" << d1.total << "\n";
    OFile.close();
    ...
    OFile << "\n"
          ...
          << "Price"
             ","
          << "Total" << endl
          << "," << d1.product << ",," << d1.quantity << "," << d1.price << "," << d1.total;
...
Add:
    ...
    Customerfile << endl
                 << setw(10) << "Name: " << left << setw(20) << c1.customername << setw(10) << "Phone No. +91-" << left << setw(20) << c1.phoneno << setw(8) << "Address: " << left << c1.Address;
